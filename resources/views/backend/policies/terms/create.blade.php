                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('terms.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="col-12 text-end">
                                        <a href="{{ route('terms.index') }}" class="btn btn-danger px-4">Cancel</a>
