        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Return & Exchange  Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Return & Exchange /li>
                </ol>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('return.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="col-12 mb-5">
                                        ...
                                        <div class="invalid-feedback">Please enter a Introduction.</div>
                                    </div>
                                    ...
                                    <div class="col-12 text-end">
                                        <a href="{{ route('return.index') }}" class="btn btn-danger px-4">Cancel</a>
