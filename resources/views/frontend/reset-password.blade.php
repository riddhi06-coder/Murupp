            ...
            <div class="container">
                <div class="login-wrap">
                    <div class="left">
                        ...
                        <form method="POST" action="{{ route('user.updatepassword.reset') }}" class="form-login form-has-password" onsubmit="return validateForm()">
                            @csrf
                            ...
                            <div class="button-submit">
                                <button class="tf-btn btn-fill" type="submit">
                                    <span class="text text-button">Reset Password</span>
                                </button>
                            </div>
                        </form>
                    ...
                    <div class="right">
                        <h4 class="mb_8">Dont't have an account?</h4>
                        <p class="text-secondary">Welcome! Register to access your personalized experience, saved preferences, and more. We're thrilled to have you with us!</p>
                        <a href="{{ route('user.login') }}" class="tf-btn btn-fill"><span class="text text-button">Register</span></a>
                    </div>
                </div>
            </div>
        </section>
